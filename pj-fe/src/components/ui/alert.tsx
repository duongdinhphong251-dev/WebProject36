...
const alertVariants = cva('flex w-full items-stretch gap-2 group-[.toaster]:w-(--width)', {
  ...
  compoundVariants: [
    ...
    },
    {
      variant: 'mono',
      appearance: 'solid',
      className: '*:data-slot-[alert=close]:text-white bg-zinc-950 text-white dark:bg-zinc-300 dark:text-black',
    },
    ...
    /* Outline */
    {
      variant: 'secondary',
      appearance: 'outline',
      className: 'border-border bg-background text-foreground [&_[data-slot=alert-close]]:text-foreground border',
    },
    {
      variant: 'primary',
      appearance: 'outline',
      className: 'border-border bg-background text-primary [&_[data-slot=alert-close]]:text-foreground border',
    },
    {
      variant: 'destructive',
      appearance: 'outline',
      className: 'border-border bg-background text-destructive [&_[data-slot=alert-close]]:text-foreground border',
    },
    {
      variant: 'success',
      appearance: 'outline',
