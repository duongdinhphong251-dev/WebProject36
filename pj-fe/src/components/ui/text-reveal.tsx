...
export function TextReveal({
  ...
  interface VisibleVariant { opacity?: number; y?: number | number[]; scale?: number | number[]; filter?: string; width?: string | number; rotateY?: number; rotateZ?: number | number[]; x?: number; transition?: Record<string, unknown> }
  const customItemVariants: Variants
    = duration === 0.6
      ...
      : ({
          ...
          visible: {
            ...(originalVariant.visible as VisibleVariant),
            transition: {
              ...((originalVariant.visible as VisibleVariant)?.transition),
              duration,
            },
          },
        } as Variants);
