...
function RadioGroup({
  ...
  return (
    <RadioGroupContext value={{ variant: variant ?? 'primary', size: size ?? 'md' }}>
...
const radioItemVariants = cva(
  `
    peer ring-offset-background focus-visible:ring-ring aria-invalid:border-destructive/60 aria-invalid:ring-destructive/10 dark:aria-invalid:border-destructive dark:aria-invalid:ring-destructive/20 [[data-invalid=true]_&]:border-destructive/60 
    [[data-invalid=true]_&]:ring-destructive/10 dark:[[data-invalid=true]_&]:border-destructive dark:[[data-invalid=true]_&]:ring-destructive/20 border-input
    text-primary data-[state=checked]:bg-primary data-[state=checked]:border-primary data-[state=checked]:text-primary-foreground
    aspect-square rounded-full  border outline-hidden
