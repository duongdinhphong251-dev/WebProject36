  ...
  'group ring-offset-background inline-flex cursor-pointer items-center justify-center text-sm font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-60 has-data-[arrow=true]:justify-between [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline: 'bg-background text-accent-foreground border-input hover:bg-accent data-[state=open]:bg-accent border',
        dashed:
      ...
      mode: {
        ...
        input: `
            hover:bg-background [&_svg]:hover:text-foreground data-[state=open]:bg-background focus-visible:border-ring focus-visible:ring-ring/30 [[data-state=open]>&]:border-ring 
            [[data-state=open]>&]:ring-ring/30 aria-invalid:border-destructive/60 aria-invalid:ring-destructive/10 dark:aria-invalid:border-destructive 
            dark:aria-invalid:ring-destructive/20 in-data-[invalid=true]:border-destructive/60 in-data-[invalid=true]:ring-destructive/10 
            dark:in-data-[invalid=true]:border-destructive 
            dark:in-data-[invalid=true]:ring-destructive/20 justify-start font-normal focus-visible:ring-[3px]
            focus-visible:outline-hidden [&_svg]:transition-colors  [[data-state=open]>&]:ring-[3px] [[data-state=open]>&]:outline-hidden
          `,
      },
      placeholder: {
    ...
    compoundVariants: [
      ...
      // Ghost
      {
        variant: 'primary',
        appearance: 'ghost',
        className: 'text-primary/90 hover:bg-primary/5 data-[state=open]:bg-primary/5 bg-transparent',
      },
      {
        variant: 'destructive',
        appearance: 'ghost',
        className: 'text-destructive/90 hover:bg-destructive/5 data-[state=open]:bg-destructive/5 bg-transparent',
      },
      {
        variant: 'ghost',
        mode: 'icon',
...
const Button = ({ ref, className, selected, variant, shape, appearance, mode, size, autoHeight, underlined, underline, asChild = false, placeholder = false, ...props }: React.ComponentProps<'button'>
