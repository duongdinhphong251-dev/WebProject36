...
const dialogContentVariants = cva(
  "border-border bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed z-50 flex max-h-[90vh] flex-col overflow-y-auto border p-6 shadow-lg shadow-black/5 outline-0 duration-200 sm:rounded-lg",
  {
    variants: {
      variant: {
        default:
                    "top-[50%] left-[50%] max-w-[90vw] min-w-[70vw] translate-x-[-50%] translate-y-[-50%] md:min-w-[50vw]",
        fullscreen: "inset-5",
      },
    },
    defaultVariants: {
