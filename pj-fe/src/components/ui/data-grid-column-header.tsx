            ...
            {column.getCanSort() && (
              <>
                ...
                >
                  ...
                  {column.getIsSorted() === 'asc' && <Check className="text-primary size-4 opacity-100!" />}
                </DropdownMenuItem>
                <DropdownMenuItem
                  onClick={() => {
                ...
                >
                  ...
                  {column.getIsSorted() === 'desc' && <Check className="text-primary size-4 opacity-100!" />}
                </DropdownMenuItem>
              </>
            )}
            ...
            {props.tableLayout?.columnsPinnable && column.getCanPin() && (
              <>
                <DropdownMenuItem onClick={() => column.pin(column.getIsPinned() === 'left' ? false : 'left')}>
                  ...
                  {column.getIsPinned() === 'left' && <Check className="text-primary size-4 opacity-100!" />}
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => column.pin(column.getIsPinned() === 'right' ? false : 'right')}>
                  ...
                  {column.getIsPinned() === 'right' && <Check className="text-primary size-4 opacity-100!" />}
                </DropdownMenuItem>
              </>
            )}
