    ...
    <div className="flex flex-col gap-3">
      ...
      <div>
        <button
          type="button"
          onClick={handleShare}
          className="flex w-full items-center justify-center gap-1.5 rounded-xl border border-[#DDE4D9] py-2.5 text-xs font-semibold text-[#40813D] transition-colors hover:bg-[#F5F7F4]"
        >
