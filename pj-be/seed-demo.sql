...
VALUES
  (1, '11111111-1111-1111-1111-111111111111', 2, 1, 'Massage body 90 phút giảm 50%', 'Full body massage 50% off', 'massage-body-90p', 'massage-body-90min', 'Thư giãn toàn thân', 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800', 'active', NOW(), NOW() + INTERVAL '30 days', 'VND', '50%', false, 100),
  (2, '22222222-2222-2222-2222-222222222222', 2, 1, 'Facial treatment giảm 40%', 'Facial 40% off', 'facial-40', 'facial-40off', 'Chăm sóc da mặt', 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=800', 'active', NOW(), NOW() + INTERVAL '30 days', 'VND', '40%', false, 90),
  (3, '33333333-3333-3333-3333-333333333333', 1, 1, 'Trị mụn công nghệ cao', 'Acne treatment', 'tri-mun', 'acne-treatment', 'Điều trị mụn', 'https://images.unsplash.com/photo-1596178060671-7a80dc8059ea?w=800', 'active', NOW(), NOW() + INTERVAL '30 days', 'VND', '35%', false, 95);
